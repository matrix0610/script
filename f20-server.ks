...
network --onboot=yes --device=eth0 --bootproto=static --ip=192.168.0.123 --netmask=255.255.255.0 --gateway=192.168.0.138 --nameserver=180.148.136.22 --noipv6 --hostname=kickstart
